<template>
    <div>
      ...
      <div class="bg-white p-6 rounded-lg shadow">
        ...
        <template v-else>
          <div v-if="statusResp.dingding_user" class="text-green-700">
            已绑定钉钉
  ...
  import { getDingtalkAuthorizeUrl, getDingtalkStatus, type DingTalkStatusResp } from '@/apis/user_api'

  const loading = ref(true)
  const btnLoading = ref(false)
  const errorMsg = ref('')
  const statusResp = ref<DingTalkStatusResp>({ dingding_user: null })
